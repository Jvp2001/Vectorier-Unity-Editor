...
public class BuildMap : MonoBehaviour
{
    ...
    public static void Build()
    {
        ...
        foreach (XmlNode node in xml.DocumentElement.SelectSingleNode("/Root/Track"))
        {
            if (node.Attributes.GetNamedItem("Factor").Value == "1")
            {
                ...
                {
                    Transform parent = imageInScene.transform.parent;
                ...
                {
                    Transform parent = objectInScene.transform.parent;
                    if (parent != null && parent.CompareTag("Dynamic"))
                    {
                        // If the parent has the tag "Dynamic" skip this GameObject and continue.
                        continue;
                ...
                {
                    Transform parent = platformInScene.transform.parent;
                    if (parent != null && parent.CompareTag("Dynamic"))
                    {
                        // If the parent has the tag "Dynamic" skip this GameObject and continue.
                        continue;
                ...
                {
                    Transform parent = triggerInScene.transform.parent;
                    if (parent != null && parent.CompareTag("Dynamic"))
                    {
                        // If the parent has the tag "Dynamic" skip this GameObject and continue.
                        continue;
                ...
                {
                    Transform parent = areaInScene.transform.parent;
                    if (parent != null && parent.CompareTag("Dynamic"))
                    {
                        // If the parent has the tag "Dynamic" skip this GameObject and continue.
                        continue;
                ...
                {
                    Transform dynamicInSceneTransform = dynamicInScene.transform;
    ...
    void ConvertToDynamic(XmlNode node, XmlDocument xml, GameObject dynamicInScene, Transform dynamicInSceneTransform)
    {
        ...
        foreach (Transform childObject in dynamicInSceneTransform)
        {
